...
class TinyNetwork(nn.Module):
  ...
  def __init__(self, C, N, max_nodes, num_classes, criterion, search_space, args, affine=False, track_running_stats=True):
    ...
    network_structure = torch.nn.functional.one_hot(args.network_init)
    print("network strcture====================", network_structure)
    self._arch_parameters = Variable(1.0 * network_structure.cuda(), requires_grad=False)
  ...
  def get_theta(self):
    ...
    return self._arch_parameters.cpu()
